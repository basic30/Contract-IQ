...
const CelestialOrbHero = () => {
  ...
  return (
    // Applied bg-black/90 for overall container opacity control
    <div className="relative min-h-screen w-full flex items-center justify-center text-center bg-black/90 text-slate-200 overflow-hidden">
      <canvas
        ref={canvasRef}
        // Added opacity-90 here to reduce the animation intensity slightly
